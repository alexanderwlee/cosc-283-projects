...
public abstract class DataLinkLayer {
   ...
   */
  protected abstract byte[] createFrame(byte[] data);
  // =========================================================================

  // =========================================================================
  /**
   * Transmit a byte as bits. Expected to be called by a subclass in performing a <code>send()
   * </code>.
   *
   ...
   */
  protected abstract byte[] processFrame();
  // ===============================================================
