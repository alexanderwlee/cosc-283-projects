...
public class LowNoiseMedium extends Medium {
  ...
  // =========================================================================
  /**
   * Send a bit from one client to the other clients. With some probability, flip a bit.
   *
   * @param sender The client physical layer sending the bit.
   * @param bit The value to be sent, where <code>false</code> sends a <code>0</code> bit, and
   *     <code>true</code> sends a <code>1</code> bit.
   * @throws RuntimeException if the sender is not registered with this medium.
   */
