...
public abstract class Medium {
  ...
  public static Medium create(String type) {
    ...
    Object o = null;
    try {
      o = mediumClass.getDeclaredConstructor().newInstance();
      ...
      throw new RuntimeException("Could not call constructor on " + className);
    ...
    try {
      ...
      throw new RuntimeException(className + " is not a subclass of Medium");
    }
  ...
  // =========================================================================
  /**
   * Register the given client as connected to the medium. If the client is already registered, do
   * nothing (no multiple registrations).
   *
  ...
  public abstract void transmit(PhysicalLayer sender, boolean bit);
  // =========================================================================
