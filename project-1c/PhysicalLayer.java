...
// =============================================================================
/**
 * Transmits bits across a medium. Bits delivered by the medium are queued until the client calls
 * for their receiption.
 *
...
public class PhysicalLayer {
   ...
   *
   * @param medium The medium on which this physical layer will transmit and receive.
  ...
  // =========================================================================
  /**
   * Called by the medium to receive a bit, which is then queued for receiption by the client.
   *
  ...
  // =========================================================================
  /**
   * Called by the client to retrieve the next queued bit received from the medium.
   *
   * @return the next bit received from the medium, if any; <code>null</code> if no bits have been
   *     received.
   */
